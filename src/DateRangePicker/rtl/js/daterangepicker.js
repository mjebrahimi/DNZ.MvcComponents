...
html += '<th></th>'; if ((!minDate || minDate.isBefore(calendar.firstDay)) && (!this.linkedCalendars || side == 'left')) { getComputedStyle(document.getElementsByTagName('body')[0]).direction == "ltr" ? html += '<th class="prev available"><i class="fa fa-chevron-left glyphicon glyphicon-chevron-left"></i></th>' : html += '<th class="prev available"><i class="fa fa-chevron-right glyphicon glyphicon-chevron-right"></i></th>'; } else { html += '<th></th>'; }
...
html += '<th colspan="5" class="month">' + dateHtml + '</th>'; if ((!maxDate || maxDate.isAfter(calendar.lastDay)) && (!this.linkedCalendars || side == 'right' || this.singleDatePicker)) { getComputedStyle(document.getElementsByTagName('body')[0]).direction == "ltr" ? html += '<th class="next available"><i class="fa fa-chevron-right glyphicon glyphicon-chevron-right"></i></th>' : html += '<th class="next available"><i class="fa fa-chevron-left glyphicon glyphicon-chevron-left"></i></th>'; } else { html += '<th></th>'; }
...
(jalaali?calendar[row][col].jDate():calendar[row][col].date())+'</td>';}
html+='</tr>';}
